...
class Monitor:
    ...
    #             # second = line[line.index("/"):]
    #             # data = first.split() + second.rsplit(maxsplit = 2)
    #             data = re.split(r'\s+', line)
    #             if any(substring in data[-1] for substring in ["Sublime Text", "bird", "quicklookd"]):
    #                 continue
    #             # print(data)
    #             timestamp = data[0]
    #             action = data[1]
